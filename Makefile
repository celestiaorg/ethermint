...
SIMAPP = ./app
HTTPS_GIT := https://github.com/celestiaorg/ethermint.git
...
PACKAGE_NAME:=github.com/celestiaorg/ethermint
...
godocs:
	@echo "--> Wait a few seconds and visit http://localhost:6060/pkg/github.com/celestiaorg/ethermint/types"
	godoc -http=:6060
...
test-import:
	go test -run TestImporterTestSuite -v --vet=off github.com/celestiaorg/ethermint/tests/importer
