...
// EmitTxRootEvent emits tx root events
...
// EmitReceiptRootEvent emits receipt root events
func (k Keeper) EmitReceiptRootEvent(ctx sdk.Context, receiptRoot common.Hash) {
	ctx.EventManager().EmitEvent(
		sdk.NewEvent(
